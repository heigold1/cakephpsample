...
/*	Configure::write('Session', array(
	...
	Configure::write('Session', array(
    	'defaults' => 'cake',
    	'cookie' => 'myapp',
    	'timeeout' => 4320 //3 days
	));

/**
 * A random string used in security hashing methods.
 */
	Configure::write('Security.salt', 'YxBkBO99L3oVIL0qGhnYXC301ZpHwtoBibRBnKqiTzaJoBAknSw5rXD7ENIFvpx');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '24323422233341431098702314230987');
